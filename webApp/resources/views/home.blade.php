        ...
        <div class="container">
            ...
            <div class="row row-20 row-lg-30">
                <div class="col-md-6 col-lg-4 wow-outer">
                    <div class="wow fadeInUp">
                        <div class="product-featured">
                            <div class="product-featured-figure"><img src="/home_page/images/genevelausanne2.png" alt="" width="370" height="395"/>
                                <div class="product-featured-button"><a class="button button-primary" href="#">Commander</a></div>
                            </div>
                ...
                <div class="col-md-6 col-lg-4 wow-outer">
                    <div class="wow fadeInUp">
                        <div class="product-featured">
                            <div class="product-featured-figure"><img src="/home_page/images/fribourgberne.png" alt="" width="370" height="395"/>
                                <div class="product-featured-button"><a class="button button-primary" href="#">Commander</a></div>
                            </div>
                            <div class="product-featured-caption">
                ...
                <div class="col-md-6 col-lg-4 wow-outer">
                    <div class="wow fadeInUp">
                        <div class="product-featured">
                            <div class="product-featured-figure"><img src="/home_page/images/yverdonlausanne.png" alt="" width="370" height="395"/>
                                <div class="product-featured-button"><a class="button button-primary" href="#">Commander</a></div>
                            </div>
                            <div class="product-featured-caption">
